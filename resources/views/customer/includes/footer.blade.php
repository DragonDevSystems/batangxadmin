<div class="footer">
     ...
     <div class="section group">
     	<?php $aboutInfo = App::make("App\Http\Controllers\AboutController")->getAboutInformation(); ?>
			...
			<div class="col_1_of_4 span_1_of_4">
				<h4>Contact</h4>
					<ul>
						<li><span>{{$aboutInfo['email']}}</span></li>
						<li><span>{{$aboutInfo['number']}}</span></li>
					</ul>
					<div class="social-icons">
						<h4>Follow Us</h4>
				   		  <ul>
						      <li><a href="{{$aboutInfo['fb_link']}}" target="_blank"><img src="{{env('FILE_PATH_CUSTOM')}}img/facebook.png" alt="" /></a></li>
						      <li><a href="{{$aboutInfo['ebay_link']}}" target="_blank"><img src="{{env('FILE_PATH_CUSTOM')}}img/ebay.png" alt="" /></a></li>
						      <div class="clear"></div>
					     </ul>
	 					</div>
			</div>
