			                    ...
			                    <div id="mover">
			                    	<div id="slide-1" class="slide">			                    
									 <div class="slider-img">
									     <a href="preview.html"><img src="{{env('FILE_PATH_CUSTOM')}}img/slide-1-image.png" alt="learn more" /></a>									    
									  </div>
									  ...
									  <div class="clear"></div>				
									   ...
									   <div class="features_list">
							             ...
							             <a href="preview.html" class="button">Shop Now</a>
						             	 ...
						             	 <div class="slider-img">
									     <a href="preview.html"><img src="{{env('FILE_PATH_CUSTOM')}}img/slide-3-image.jpg" alt="learn more" /></a>
									  </div>						             					                 
									  <div class="clear"></div>				
				                  </div>
				                  <div class="slide">						             	
					                  <div class="slider-img">
									     <a href="preview.html"><img src="{{env('FILE_PATH_CUSTOM')}}img/slide-2-image.jpg" alt="learn more" /></a>
									  </div>
									  <div class="slider-text">
		                                 <h1>Clearance<br><span>SALE</span></h1>
		                                 <h2>UPTo 10% OFF</h2>
    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
			...
			<div class="section group">
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="preview.html"><img src="{{env('FILE_PATH_CUSTOM')}}img/new-pic1.jpg" alt="" /></a>					
					 <h2>Lorem Ipsum is simply </h2>
					<div class="price-details">
				       <div class="price-number">
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="preview.html"><img src="{{env('FILE_PATH_CUSTOM')}}img/new-pic2.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>
					 <div class="price-details">
				       <div class="price-number">
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href="preview.html"><img src="{{env('FILE_PATH_CUSTOM')}}img/new-pic4.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>
					<div class="price-details">
				       <div class="price-number">
				...
				<div class="grid_1_of_4 images_1_of_4">
				 <a href="preview.html"><img src="{{env('FILE_PATH_CUSTOM')}}img/new-pic3.jpg" alt="" /></a>
					 <h2>Lorem Ipsum is simply </h2>					 
					 <div class="price-details">
				       <div class="price-number">
